...
export default function LandingPage() {
  return (
    ...
    >
      ...
      <section
        id="section-grade"
        className="relative min-h-screen flex items-center bg-[#07090E] overflow-hidden"
      >
        ...
        <div className="pointer-events-none absolute inset-0 z-[1] opacity-[0.14]">
          <DitherShader
            src="/images/canada-landmarks-cn-tower-toronto.jpg"
            gridSize={4}
            ditherMode="bayer"
            colorMode="grayscale"
            invert={false}
        ...
        <div className="pointer-events-none absolute inset-0 z-[2] bg-gradient-to-r from-[#07090E] via-[#07090E]/72 to-[#07090E]/38" />
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-8 sm:px-16 py-32 flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <FadeIn className="flex-1 min-w-0">
            <p className="mb-5 text-[10px] tracking-[0.3em] text-zinc-600">
              01 / INTELLIGENCE
            </p>
            ...
            <p className="mt-6 text-base text-zinc-400 leading-relaxed max-w-md">
              A 90% at one school isn't the same as a 90% at another. Test
              difficulty, curriculum depth, time pressure, and question style
              all shape what a grade is actually worth — and right now, none of
              that is visible.
            </p>
            <p className="mt-4 text-base text-zinc-500 leading-relaxed max-w-md">
              AXIOM uses{" "}
              <span className="text-zinc-300 font-medium">Backboard.io AI</span>{" "}
              to read real exam PDFs, count questions, detect cognitive
              difficulty, and compare against provincial curriculum standards —
              automatically.
            </p>
          </FadeIn>
          ...
          <FadeIn delay={0.15} className="flex-1 min-w-0 w-full">
            <div className="rounded-2xl border border-white/8 bg-[#0d1117] p-6 shadow-2xl max-w-sm mx-auto lg:mx-0 lg:ml-auto">
              ...
              <div className="flex flex-wrap gap-2 mb-5">
                ...
                <span className="rounded-full border border-white/8 bg-white/5 px-2.5 py-0.5 text-xs text-zinc-200">
                  28
                </span>
              ...
              <div className="rounded-xl border border-white/6 bg-white/3 p-4">
                ...
                <p className="text-xs text-zinc-300 leading-relaxed">
                  This test covers 2 topics beyond standard BC Grade 12
                  curriculum, indicating above-average expectations.
                </p>
              </div>
            </div>
          </FadeIn>
      ...
      <section
        id="section-standard"
        className="relative min-h-screen flex items-center overflow-hidden bg-[#080B10]"
      >
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-8 sm:px-16 py-32 flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-24">
          ...
          <FadeIn className="flex-1 min-w-0">
            ...
            <p className="mt-6 text-base text-zinc-400 leading-relaxed max-w-md">
              We map schools across every province and territory. When a test is
              analyzed, its adjustment factor gets pinned to that school on the
              map — building a living, data-driven picture of grading standards
              nationwide.
            </p>
            <p className="mt-4 text-base text-zinc-500 leading-relaxed max-w-md">
            ...
            <div className="mt-10 grid grid-cols-2 gap-3 max-w-md">
              {[
                {
                  icon: "🗺️",
                  label: "Live school map",
                  sub: "BC · AB · QC and beyond",
                },
                {
                  icon: "📄",
                  label: "PDF upload",
                  sub: "No copy-paste required",
                },
                {
                  icon: "🎓",
                  label: "Curriculum check",
                  sub: "Province-by-province",
                },
                {
                  icon: "⚖️",
                  label: "Inflation detector",
                  sub: "Transparent & auditable",
                },
              ].map(({ icon, label, sub }) => (
                <div
                  key={label}
                  className="rounded-xl border border-white/7 bg-white/3 p-4 flex gap-3 items-start"
                >
            ...
            <div className="mt-10">
              <Link
                href="/globe"
                className="inline-block rounded-md bg-white px-8 py-3.5 text-xs font-semibold tracking-[0.12em] text-black transition hover:bg-zinc-100"
              >
                ENTER AXIOM →
              </Link>
            </div>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span
                        className={`text-xs font-semibold ${s.pos ? "text-emerald-400" : "text-rose-400"}`}
                      >
                        {s.adj}
                      </span>
                      <span
                        className={`text-[9px] px-1.5 py-0.5 rounded-full ${s.pos ? "bg-emerald-500/10 text-emerald-500" : "bg-rose-500/10 text-rose-500"}`}
                      >
